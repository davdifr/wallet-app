            ...
            <div className="container flex min-h-screen flex-col justify-center gap-10 py-10 lg:flex-row lg:items-center">
                <div className="max-w-xl space-y-6">
                    ...
                    <div className="space-y-4">
                        <h1 className="font-display text-4xl font-semibold tracking-tight text-foreground sm:text-5xl">
                            Gestisci il tuo wallet con un dashboard pulito,
                            veloce e sicuro.
                        </h1>
                        <p className="max-w-lg text-base text-muted-foreground sm:text-lg">
                            Tieni sotto controllo entrate, spese, obiettivi e
                            risparmi in un unico spazio semplice da usare.
                        </p>
                    </div>
                ...
                <AuthCard>
                    ...
                    <p className="text-center text-sm text-muted-foreground">
                        Dopo l&apos;accesso entrerai subito nella tua area
                        personale.
                    </p>
                </AuthCard>
            </div>
